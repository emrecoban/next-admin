                        ...
                        <section className="py-6 w-full max-w-xl">
                            ...
                            <div className="flex flex-col rounded-lg shadow-sm bg-white overflow-hidden">
                                <div className="p-5 md:px-16 md:py-12 grow">
                                    <form className="space-y-6">
                                        <div className="space-y-1">
                                            ...
                                            <input type="email" id="email" name="email" placeholder="Enter your email" className="w-full block border placeholder-gray-500 px-5 py-3 leading-6 rounded-lg border-gray-200 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" />
                                        </div>
                                        <div className="space-y-1">
                                            <label htmlFor="password" className="text-sm font-medium">Password</label>
                                            <input type="password" id="password" name="password" placeholder="Enter your password" className="w-full block border placeholder-gray-500 px-5 py-3 leading-6 rounded-lg border-gray-200 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" />
                                        </div>
                                        <div>
                                            <div className="flex items-center justify-between space-x-2 mb-5">
                                                <label className="flex items-center">
                                                    <input type="checkbox" id="remember_me" name="remember_me" className="border border-gray-200 rounded h-4 w-4 text-blue-500 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" />
                                                    <span className="text-sm ml-2">Remember me</span>
                                                </label>
                                                <a href="#" className="text-sm font-medium inline-block text-blue-600 hover:text-blue-400">Forgot Password?</a>
                                            </div>
                                            ...
                                            <div className="flex items-center my-5">
                                                <span aria-hidden="true" className="grow bg-gray-100 rounded h-0.5" />
                                                <span className="text-xs font-medium text-gray-800 bg-gray-100 rounded-full px-3 py-1">or sign in with</span>
                                                <span aria-hidden="true" className="grow bg-gray-100 rounded h-0.5" />
                                            </div>
                                ...
                                <div className="p-5 md:px-16 grow text-sm text-center bg-gray-50">
                                    ...
                                    <a href="#" className="font-medium text-blue-600 hover:text-blue-400">Sign up</a>
                                </div>
                            </div>
                            {/* END Sign In Form */}
                            ...
                            <div className="text-sm text-gray-500 text-center mt-6">
                                Powered by <a href="#" className="font-medium text-blue-600 hover:text-blue-400">Tailkit</a>
                            </div>
                            {/* END Footer */}
                        </section>
                        {/* END Sign In Section */}
